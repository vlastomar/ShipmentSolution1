...
namespace ShipmentSolution.Data.Configurations
{
    public class RouteConfiguration : IEntityTypeConfiguration<Route>
    {
        public void Configure(EntityTypeBuilder<Route> builder)
        {
            ...
            builder.Property(r => r.StartLocation).HasMaxLength(ValidationConstants.Route.LocationMaxLength);
            builder.Property(r => r.EndLocation).HasMaxLength(ValidationConstants.Route.LocationMaxLength);
